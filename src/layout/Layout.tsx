...
const Layout = ({ modal, setModal }: ParamsLayout): JSX.Element => {
  ...
  return (
    <div id="layout">
                <div className={modal ? 'invisible' : ''} id="open-modal" onClick={() => setModal(true)}>
        ...
        <aside className={modal ? 'side-bar modal-visible' : 'side-bar'}>
          <nav id="nav-bar">
            ...
            <Link to="/projects" className={pathname === '/projects' ? 'nav-link active' : 'nav-link'}>
              Projects
            </Link>
            <Link to="/skills" className={pathname === '/skills' ? 'nav-link active' : 'nav-link'}>
              Skills
            </Link>
